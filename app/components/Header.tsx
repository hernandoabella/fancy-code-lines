...
import { ModeToggle } from "@/app/components/Dropdown";
    ...
    >
      <div className="text-center pt-5 md:pt-20 mx-auto px-10">
        ...
        <h1 className="text-4xl font-extrabold tracking-tight text-gray-900 dark:text-slate-200 sm:text-3xl md:text-5xl">
          ...
          <div className="mt-2">
            <span className="relative mt-3 whitespace-nowrap text-orange-500">
              <svg
                aria-hidden="true"
                viewBox="0 0 418 42"
                className="absolute top-3/4 left-0 right-0 m-auto h-[0.58em] w-fit fill-orange-400/60"
              ...
              <span className="relative">Fancy Code Lines</span>
            </span>
          </div>
        </h1>
